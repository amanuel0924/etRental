    ...
    <div className=" h-screen w-full ">
      {isLoading ? (
        ...
        <div className="w-full h-full flex flex-col px-5 ">
          ...
          {user.role === "renter" && (
            <div className="bg-white overflow-hidden shadow rounded-lg border h-full sm:h-fit mt-5  ">
              <div className="px-4 py-5 sm:px-6">
                <h3 className="text-lg leading-6 font-medium text-gray-900">
                  Pending Details
                </h3>
              ...
              <div className="border-t border-gray-200 px-4 py-5 sm:p-0">
                <dl className="sm:divide-y sm:divide-gray-200">
                  ...
                  <div className="py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                      {data?.houseEntityId?.hasBroker === true ? "Yes" : "No"}
                    </dd>
                  </div>
                  <div className="py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    <dt className="text-sm font-medium text-gray-500">
                  ...
                  <div className="py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                      {data?.houseEntityId?.siteLocation}
                    </dd>
                  </div>
                  {data?.status === "couterOffer" && (
                    <div className="py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                      <dt className="text-sm font-medium text-gray-500">
                        Counter Offer Price
                        <br />
                        <span className="text-gray-400 text-xs">
                          {data?.couterOfferPrice}
                        </span>
                      </dt>
          ...
          <div className="flex flex-col  sm:flex-row bg-white overflow-hidden shadow rounded-lg border h-fit justify-between p-4 mt-2 ">
