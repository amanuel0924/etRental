...
function Houses() {
  ...
  const { data, error, isLoading, refetch } = useGetAllHouseforadminQuery({
    pageNumber,
    keyword,
  })
  const [deleteHouse, { isLoading: deleteLoading }] =
    useDeleteHousePermanentMutation()
      ...
      <Modal open={open} onClose={() => setOpen(false)}>
        <div className="flex flex-col items-center  justify-center">
          <h1 className="text-xl font-bold text-red-500">
            Are you sure you want to delete Permanetly this house?
          </h1>
